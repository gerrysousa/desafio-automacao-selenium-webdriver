...
public class CriarMarcadorPage extends BasePage{
	...
	public void clicarBotaoEditarMarcador() {
		...
		clicar(By.cssSelector("#main-container > div.main-content > div.page-content > div > div > div.widget-box.widget-color-blue2 > div.widget-body > div > div:nth-child(3) > form:nth-child(1) > fieldset > input.btn.btn-primary.btn-white.btn-round"));
	}
	...
	public void clicarBotaoExcluirMarcador() {
		clicar(By.cssSelector("#main-container > div.main-content > div.page-content > div > div > div.widget-box.widget-color-blue2 > div.widget-body > div > div:nth-child(3) > form:nth-child(2) > fieldset > input.btn.btn-primary.btn-white.btn-round"));			
	}

	public void clicarConfirmarExclusao() {
		clicar(By.cssSelector("#main-container > div.main-content > div.page-content > div > div > div.alert.alert-warning.center > form > input.btn.btn-primary.btn-white.btn-round"));
